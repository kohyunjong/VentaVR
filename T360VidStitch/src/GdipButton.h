...
public:
	...
	int GetCurType();
	void Disable(CGdipButton* btn);
	void Enable(CGdipButton* btn);
	...
	BOOL LoadOnOvrImage(UINT id, LPCTSTR pType);
	BOOL LoadOnPressImage(UINT id, LPCTSTR pType);
	BOOL LoadImages(UINT stdid, UINT altid, UINT ovrid, UINT prsid, UINT onovrid, UINT onprsid, LPCTSTR pType);
...
protected:
	...
	CGdiPlusBitmapResource* m_pOnPressImage;
	CGdiPlusBitmapResource* m_pOnOverImage;
