...
#if (!(__PGIC__ == 15 && __PGIC_MINOR__ == 9) && !(__PGIC__ == 99 && __PGIC_MINOR__ == 99)) || !defined(__GNUC__) || !defined(__LP64__)

#error -- unsupported pgc++ configuration! Only pgc++ 15.9 on Linux x86_64 is supported!

#endif /* (!(__PGIC__ == 15 && __PGIC_MINOR == 9) && !(__PGIC__ == 99 && __PGIC_MINOR__ == 99 )) || !__GNUC__ || !__LP64__ */
