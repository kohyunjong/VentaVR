...
typedef enum CUpti_driver_api_trace_cbid_enum {
    ...
    CUPTI_DRIVER_TRACE_CBID_cuEGLStreamProducerPresentArray                                = 448,
    CUPTI_DRIVER_TRACE_CBID_cuEGLStreamProducerPresentDevicePtr                            = 449,
    ...
    CUPTI_DRIVER_TRACE_CBID_SIZE                                                           = 457,
