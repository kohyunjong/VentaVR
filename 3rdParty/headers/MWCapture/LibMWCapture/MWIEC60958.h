...
inline int IEC60958_GetBitsPerSample(BYTE byWordLength)
{
	switch (byWordLength) {
	case 2:		return 16;
	case 3:		return 20;
...
inline DWORD IEC60958P_GetSampleRate(IEC60958_CHANNEL_STATUS * pStatus)
{
...
inline DWORD IEC60958C_GetSampleRate(IEC60958_CHANNEL_STATUS * pStatus)
{
...
inline BOOLEAN IEC60958_ParseChannelStatus(IEC60958_CHANNEL_STATUS * pStatus, BOOLEAN * pbLPCM, DWORD * pdwSampleRate, int * pnBitsPerSample)
{
	BOOLEAN bLPCM;
