...
protected:
	...
	//CXTPRadioButtonPart* m_pShowMcWeek;    // Store Show Multicolumns Week radio button part object.
	CXTPCheckboxButtonPart* m_pShowMcWeek;    // Store Show Multicolumns Week radio button part object.
	CXTPCheckboxButtonPart* m_pShowTimeline;  // Store Show Timeline radio button part object.
	//---------------------------------
