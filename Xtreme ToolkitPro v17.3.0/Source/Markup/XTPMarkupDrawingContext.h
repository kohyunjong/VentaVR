...
public:
	...
	XTPMarkupSmoothingMode SetSmoothingMode(XTPMarkupSmoothingMode smoothingMode, BOOL bUseTextSmooting);
	void SetUseTextSmooting(BOOL bUseTextSmooting);
...
AFX_INLINE void CXTPMarkupDrawingContext::SetUseTextSmooting(BOOL bUseTextSmooting) {
	m_bUseTextSmooting = bUseTextSmooting;
}

AFX_INLINE BOOL CXTPMarkupDrawingContext::GetUseTextSmooting() const {
	return m_bUseTextSmooting;
}
