...
#define _XTPLIB_VERSION_                    MAKELONG(3, 17)

// Xtreme Toolkit Pro Major version number
#define _XTPLIB_VERSION_MAJOR               17
...
#define _XTPLIB_VERSION_PREFIX              1730
...
#define _XTP_COPYRIGHT_INFO _T("Copyright © 1998-2016 Codejock Software")
