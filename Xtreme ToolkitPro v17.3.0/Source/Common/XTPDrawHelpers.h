...
public:
	...
	//-----------------------------------------------------------------------
	static COLORREF DarkenColorLum(COLORREF clr, double dPercent);
	...
	//-----------------------------------------------------------------------
	static COLORREF GreyScaleColor(COLORREF clr);
	...
	//-----------------------------------------------------------------------
	static void AFX_CDECL DrawExpandArrow(CDC* pDC, CPoint pt, BOOL bExpanded, COLORREF clrArrow, COLORREF clrBack);
	...
	//-----------------------------------------------------------------------
	static BOOL StretchImageListImage(CDC* pDC, CRect rcDest, CImageList* pImageList, int nImage);
	...
	//-----------------------------------------------------------------------
	static BOOL ProcessPendingPaintMessages(HWND hWnd = NULL);
...
enum XTPPrimitiveSymbol
{
	...
	xtpPrimitiveSymbolLast = xtpPrimitiveSymbolEllipsis
};
...
//-------------------------------------------------------------------------
_XTP_EXT_CLASS CXTPPrimitiveDrawer* XTPPrimitiveDrawer();
