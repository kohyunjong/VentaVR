...
public:
    ...
    //-----------------------------------------------------------------------
    // Summary:    Sets the maximum number of user colors displayed in the
	//             color selector control.  By default a maximum of 8 colors
	//             are displayed.
    // Parameters: nMaxRecentColors - Sets the maximum number of recent colors
	//                                displayed at any given time.  Set this 
	//                                value to -1 to display unlimited colors.
    //-----------------------------------------------------------------------
	static void AFX_CDECL SetMaxRecentColors(int nMaxRecentColors = -1);
...
//{{AFX_CODEJOCK_PRIVATE
	static void AFX_CDECL SetUserColors(const CUIntArray& arUserDefColors) { SetRecentColors(arUserDefColors); }; // deprecated
	static CUIntArray& AFX_CDECL GetUserColors() { return GetRecentColors(); }; // deprecated
//}}AFX_CODEJOCK_PRIVATE
