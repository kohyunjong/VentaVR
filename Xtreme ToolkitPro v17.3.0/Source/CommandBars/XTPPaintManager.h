...
private:
	friend CXTPPaintManager* AFX_CDECL XTPPaintManager();
...
public:
	...
	//-----------------------------------------------------------------------
	static CXTPPaintManager* GetInstanceAddRef();
...
protected:
	...
	virtual CSize DrawControlText(CDC* pDC, CXTPControl* pButton, CRect rcText, BOOL bDraw, BOOL bTriangled, CSize szButton, BOOL bDrawImage);
...
//     <code>XTPPaintManager()->GetIconsInfo()->bIconsWithShadow = FALSE;</code>
//---------------------------------------------------------------------------
AFX_INLINE CXTPPaintManager* AFX_CDECL XTPPaintManager() {
	ASSERT("A call to XTPPaintManager() must be made between calls to " 
		"CXTPPaintManager::GetInstanceAddRef() and CXTPPaintManager::ReleaseInstance(). "
		"A call to CXTPPaintManager::GetInstanceAddRef() has not been made yet."
		&& NULL != CXTPPaintManager::s_pInstance);
