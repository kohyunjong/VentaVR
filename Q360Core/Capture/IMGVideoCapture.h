#ifndef __IMGVIDEO_CAPTURE_QURAM_H__
#define __IMGVIDEO_CAPTURE_QURAM_H__
...
class IMGVideoCapture : public VideoCapture {
public:
	IMGVideoCapture();

	static IMGVideoCapture* create_VideoCapture(int iCam, int iChannel, int captureWidth, int captureHeight, float capturFPS, char* imagePath);
	static BOOL destroy_VideoCapture(IMGVideoCapture* instance);

	BOOL init_VideoCapture(int iCam, int iChannel, int captureWidth, int captureHeight, float capturFPS, char* imagePath);
...
#endif // __IMGVIDEO_CAPTURE_QURAM_H__