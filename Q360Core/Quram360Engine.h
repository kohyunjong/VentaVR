...
public:
	...
	//171012
	static int QVS_getRegionalWarpingViewMode();
	static int QVS_setRegionalWarpingViewMode(int mode);
	static int QVS_SelectWarpingPoint(int x, int y, int w, int h, int mode);
	static int QVS_DoRegionalWarping();
	static int QVS_ResetRegionalWarping();
	static int QVS_isDeleteRegionalWarping();
	static int QVS_deleteRegionalWarping();
	static int QVS_GetRegionalWarpingMode();
	static int QVS_GetRegionalWarpingSize();
	static int QVS_GetRegionalWarpingLength();
	static int QVS_GetRegionalWarpingAutoMode();
	static int QVS_SetRegionalWarpingMode(int mode);
	static int QVS_SetRegionalWarpingSize(int size);
	static int QVS_SetRegionalWarpingLength(int length);
	static int QVS_SetRegionalWarpingAutoMode(int autoMode);
